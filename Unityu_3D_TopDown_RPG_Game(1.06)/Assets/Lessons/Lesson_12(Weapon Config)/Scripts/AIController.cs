...
namespace Lesson_12
{
    ...
    public class AIController : MonoBehaviour
    {
        ...
        public void ResetState()
        {
            ...
            timeSinceLastSawPlayer = Mathf.Infinity; // 마지막으로 플레이어를 본 시간
            timeSinceArrivedAtWaypoint = Mathf.Infinity; // 순찰 지점에 도착한 시간
            timeSinceAggrevated = Mathf.Infinity; // 공격 상태로 전환한 후 경과한 시간
            currentWaypointIndex = 0; // 현재 순찰 지점 인덱스
        }
